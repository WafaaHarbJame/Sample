...
public class DrawBitmapActivity extends Activity implements OnClickListener
{
	...
	private void printBase64Image()
	{
		...
		MainActivity.mBixolonLabelPrinter.beginTransactionPrint();
		MainActivity.mBixolonLabelPrinter.drawBase64Image(base64ImageStr, false, horizontalStartPosition, verticalStartPosition, width, level, dithering==false?0:1, 1, 0, 50);
		MainActivity.mBixolonLabelPrinter.print(1, 1);
		MainActivity.mBixolonLabelPrinter.endTransactionPrint();
	}
}
